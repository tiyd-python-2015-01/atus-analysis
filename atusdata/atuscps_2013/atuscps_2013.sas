...
*;
data atuscps_2013;
infile "c:\atuscps_2013.dat" firstobs=2 dsd missover lrecl=16384 dlm=",";
length
TUCASEID $14
TULINENO 8
GEPSEUCL 8
...
label GEREG = "Region";
label GESTCEN = "Census state code";
...
label PXGR6COR = "PEGR6COR: allocation flag";
label PXGRPROF = "PEGRPROF: allocation flag";
...
label PXMS123 = "PEMS123: allocation flag";
...
7 = "Other"
;
proc contents data=atuscps_2013; run;
