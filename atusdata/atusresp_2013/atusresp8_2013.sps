...
*TRNHHCHILD       (TRNHHCHD) .
*TROHHCHILD       (TROHHCH)  .
*TRTALONE_WK      (TRTALOWK) .
*TRTCCC_WK        (TRTCCCWK) .
*TRTFAMILY        (TRTFAMIL) .
*TRTFRIEND        (TRTFREND) .
*TRTHHFAMILY      (TRTHHFAM) .
*TRTNOCHILD       (TRTNOCH)  .
*TRTOHHCHILD      (TRTOHHCH) .
*TRTONHHCHILD     (TRTONHHC) .
*TRTSPONLY        (TRTSPNLY) .
*TRTSPOUSE        (TRTSPOUS) .
*TRTUNMPART       (TRTUNMPR) .
*TRYHHCHILD       (TRYHHCHD) .
*TUCC5B_CK        (TUCC5BCK) .
*TUDIARYDATE      (TUDIDATE) .
*TUDIARYDAY       (TUDIDAY)  .
*TUFINLWGT        (TUFINWGT) .
*TXSPEMPNOT       (TXSPEMNT) .
...
TRHHCHLD "Presence of household children < 18" /
...
TRNHHCHD "Presence of own non-household child < 18" /
TRNUMHOU "Number of people living in respondent's household" /
TROHHCH "Presence of own household children < 18" /
...
TRTALOWK "Total work- and nonwork-related time respondent spent alone (in minutes)" /
...
TRTCCCWK "Total work- and nonwork-related time respondent spent with customers, clients, and coworkers (in minutes)" /
...
TRTFAMIL "Total time respondent spent with family members" /
TRTFREND "Total time respondent spent with friends" /
TRTHH "Total time spent during diary day providing secondary childcare for household children < 13" /
TRTHHFAM "Total time respondent spent with household family members" /
TRTNOCH "Total time respondent spent with non-own children < 18" /
...
TRTOHHCH "Total time respondent spent with own household children < 18" /
TRTONHH "Total time spent during diary day providing secondary childcare for own non-household children < 13" /
TRTONHHC "Total time respondent spent with own non-household children < 18" /
TRTSPNLY "Total time respondent spent with spouse only" /
TRTSPOUS "Total time respondent spent with spouse [others may be present]" /
TRTUNMPR "Total time respondent spent with unmarried partner [others may be present]" /
...
TUCC5BCK "Reason respondent did not report secondary childcare activities for non-own household children" /
...
TUDIDATE "Date of diary day [date about which the respondent was interviewed]" /
...
TXSPEMNT "TESPEMPNOT: allocation flag" /
