...
*;
data atusresp_2013;
infile "c:\atusresp_2013.dat" firstobs=2 dsd missover lrecl=16384 dlm=",";
length
 TUCASEID $14
 TULINENO 8
 TUYEAR 8 
...
label TRWBMODR = "Well-being Module respondent";
...
;
proc contents data=atusresp_2013; run;
